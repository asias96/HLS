...
void AESL_WRAP_fir(double , double *, signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_fir(double %%22, double* %%out, i32* %%12) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_63_count);
  AESL_WRAP_fir(llvm_cbe_tmp__15, (double *)(&llvm_cbe_out), (signed int *)llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
