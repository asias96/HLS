...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fir_sitodp_32ns_64_6_1_U3", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fir {
		probe_in {Type I LastRead 53 FirstWrite -1}
		out_r {Type O LastRead -1 FirstWrite 63}
		coeff {Type I LastRead 45 FirstWrite -1}
