...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_dadd_64ns_64nbkb_U1->din0(grp_fu_178_p0);
    fir_dadd_64ns_64nbkb_U1->din1(grp_fu_178_p1);
    fir_dadd_64ns_64nbkb_U1->ce(grp_fu_178_ce);
    fir_dadd_64ns_64nbkb_U1->dout(grp_fu_178_p2);
    ...
    fir_dmul_64ns_64ncud_U2->din0(grp_fu_184_p0);
    fir_dmul_64ns_64ncud_U2->din1(grp_fu_184_p1);
    fir_dmul_64ns_64ncud_U2->ce(grp_fu_184_ce);
    fir_dmul_64ns_64ncud_U2->dout(grp_fu_184_p2);
    ...
    fir_sitodp_32ns_6dEe_U3->din0(grp_fu_189_p0);
    fir_sitodp_32ns_6dEe_U3->ce(ap_var_for_const0);
    fir_sitodp_32ns_6dEe_U3->dout(grp_fu_189_p1);
