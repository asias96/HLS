...
void fir(const type_data, type_data*, const type_coeff[10]);
# 3 "LAB1_FIR/.settings/fir.c" 2


void fir(const type_data probe_in, type_data* out, const type_coeff coeff[10])
{_ssdm_SpecArrayDimSize(coeff, 10);
_ssdm_SpecArrayReshape( coeff, 1,  "COMPLETE",  0, "");
_ssdm_op_SpecResource(coeff, "", "RAM_1P_BRAM", "", -1, "", "", "", "", "");
_ssdm_op_SpecInterface(out, "ap_vld", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
