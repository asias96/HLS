# ==============================================================
# File generated on Wed Oct 23 11:48:25 CEST 2019
...
HLS_SOURCES = ../../../.settings/fir_test.cpp ../../../.settings/fir.cpp
...
$(ObjDir)/fir.o: ../../../.settings/fir.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../.settings/fir.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
