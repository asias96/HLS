...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_1_AXIS TUSER" *) input [1:0]SLOT_1_AXIS_tuser;
  ...
  wire [5:0]Conn1_TDEST;
  wire [4:0]Conn1_TID;
  wire [3:0]Conn1_TKEEP;
  wire Conn1_TLAST;
  wire Conn1_TREADY;
  wire [3:0]Conn1_TSTRB;
  wire [1:0]Conn1_TUSER;
  wire Conn1_TVALID;
  ...
  wire [5:0]net_slot_1_axis_tdest;
  ...
  wire [1:0]net_slot_1_axis_tuser;
  wire net_slot_1_axis_tvalid;
  wire resetn_1;

  assign Conn1_TDATA = SLOT_1_AXIS_tdata[31:0];
  assign Conn1_TDEST = SLOT_1_AXIS_tdest[5:0];
  ...
  assign Conn1_TUSER = SLOT_1_AXIS_tuser[1:0];
