...
set InstName instance_in_data_str_U
...
set ID 29
set FifoName fifo_w8_d2_A
set InstName instance_out_data_st_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 30
set FifoName start_for_rozmycie_U0
set InstName start_for_rozmycie_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 31
set FifoName start_for_Mat2AXIvideo_U0
set InstName start_for_Mat2AXIvideo_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 32 \
			corename filtr_Gauss_bun_1_axilite \
			name filtr_Gauss_bun_1_s_axi \
			ports {$port_bun_1} \
			op interface \
			is_flushable 0 \ 
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'bun_1'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler filtr_Gauss_bun_1_s_axi
}
