...
if {[file isfile filtr_Gauss.autotvin.dat]} {
	file delete -force filtr_Gauss.autotvin.dat
}

if {[file isfile filtr_Gauss.autotvout.dat]} {
	file delete -force filtr_Gauss.autotvout.dat
}
