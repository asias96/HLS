...
`define TV_OUT_out_r_TDATA "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_data_V.dat"
`define TV_OUT_out_r_TKEEP "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_keep_V.dat"
`define TV_OUT_out_r_TSTRB "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_strb_V.dat"
`define TV_OUT_out_r_TUSER "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_user_V.dat"
`define TV_OUT_out_r_TLAST "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_last_V.dat"
`define TV_OUT_out_r_TID "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_id_V.dat"
`define TV_OUT_out_r_TDEST "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_dest_V.dat"
...
module AESL_axi_s_out_r (
    input clk,
    input reset,
    input [8 - 1:0] TRAN_out_r_TDATA,
    input TRAN_out_r_TKEEP,
    input TRAN_out_r_TSTRB,
    ...
    reg [8 - 1:0] out_r_TDATA_write_data;
    reg out_r_TDATA_read_en;
    wire [8 - 1:0] out_r_TDATA_read_data;
    
    fifo #(921600, 8) fifo_out_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [1 - 1:0] out_r_TKEEP_write_data;
    reg out_r_TKEEP_read_en;
    wire [1 - 1:0] out_r_TKEEP_read_data;
    
    fifo #(921600, 1) fifo_out_r_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [1 - 1:0] out_r_TSTRB_write_data;
    reg out_r_TSTRB_read_en;
    wire [1 - 1:0] out_r_TSTRB_read_data;
    
    fifo #(921600, 1) fifo_out_r_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(921600, 1) fifo_out_r_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(921600, 1) fifo_out_r_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(921600, 1) fifo_out_r_TDEST (
        .reset(1'b0),
        .write_clock(clk),
