...
architecture behav of filtr_Gauss is 
    ...
    "filtr_Gauss,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.283000,HLS_SYN_LAT=5541215,HLS_SYN_TPT=4618013,HLS_SYN_MEM=2,HLS_SYN_DSP=5,HLS_SYN_FF=701,HLS_SYN_LUT=1615,HLS_VERSION=2018_3}";
