...
set InstName img_in_data_stream_0_U
...
# FIFO definition:
set ID 32
set FifoName start_for_gauss_blur_U0
set InstName start_for_gauss_blur_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 34 \
			corename gauss_bun_1_axilite \
			name gauss_bun_1_s_axi \
			ports {$port_bun_1} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gauss_bun_1_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TDATA { O 8 vector } } \
} "
} else {
