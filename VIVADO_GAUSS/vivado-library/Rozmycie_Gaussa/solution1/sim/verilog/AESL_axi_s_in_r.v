...
`define TV_IN_in_r_TDATA "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_data_V.dat"
`define TV_IN_in_r_TKEEP "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_keep_V.dat"
`define TV_IN_in_r_TSTRB "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_strb_V.dat"
`define TV_IN_in_r_TUSER "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_user_V.dat"
`define TV_IN_in_r_TLAST "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_last_V.dat"
`define TV_IN_in_r_TID "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_id_V.dat"
`define TV_IN_in_r_TDEST "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_dest_V.dat"
...
module AESL_axi_s_in_r (
    input clk,
    input reset,
    output [8 - 1:0] TRAN_in_r_TDATA,
    output TRAN_in_r_TKEEP,
    output TRAN_in_r_TSTRB,
    ...
    reg [8 - 1:0] in_r_TDATA_write_data;
    reg in_r_TDATA_read_en;
    wire [8 - 1:0] in_r_TDATA_read_data;
    
    fifo #(921600, 8) fifo_in_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [1 - 1:0] in_r_TKEEP_write_data;
    reg in_r_TKEEP_read_en;
    wire [1 - 1:0] in_r_TKEEP_read_data;
    
    fifo #(921600, 1) fifo_in_r_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [1 - 1:0] in_r_TSTRB_write_data;
    reg in_r_TSTRB_read_en;
    wire [1 - 1:0] in_r_TSTRB_read_data;
    
    fifo #(921600, 1) fifo_in_r_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
