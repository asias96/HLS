// ==============================================================
// File generated on Wed Jan 22 10:57:29 CET 2020
...
#define AUTOTB_TVIN_in_V_data_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_data_V.dat"
...
#define AUTOTB_TVIN_in_V_keep_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_keep_V.dat"
...
#define AUTOTB_TVIN_in_V_strb_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_strb_V.dat"
...
#define AUTOTB_TVIN_in_V_user_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_user_V.dat"
...
#define AUTOTB_TVIN_in_V_last_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_last_V.dat"
...
#define AUTOTB_TVIN_in_V_id_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_id_V.dat"
...
#define AUTOTB_TVIN_in_V_dest_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_in_V_dest_V.dat"
...
#define AUTOTB_TVOUT_out_V_data_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_data_V.dat"
#define AUTOTB_TVIN_out_V_data_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_data_V.dat"
...
#define AUTOTB_TVOUT_out_V_keep_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_keep_V.dat"
#define AUTOTB_TVIN_out_V_keep_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_keep_V.dat"
...
#define AUTOTB_TVOUT_out_V_strb_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_strb_V.dat"
#define AUTOTB_TVIN_out_V_strb_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_strb_V.dat"
...
#define AUTOTB_TVOUT_out_V_user_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_user_V.dat"
#define AUTOTB_TVIN_out_V_user_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_user_V.dat"
...
#define AUTOTB_TVOUT_out_V_last_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_last_V.dat"
#define AUTOTB_TVIN_out_V_last_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_last_V.dat"
...
#define AUTOTB_TVOUT_out_V_id_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_id_V.dat"
#define AUTOTB_TVIN_out_V_id_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_id_V.dat"
...
#define AUTOTB_TVOUT_out_V_dest_V  "../tv/cdatafile/c.filtr_Gauss.autotvout_out_V_dest_V.dat"
#define AUTOTB_TVIN_out_V_dest_V  "../tv/cdatafile/c.filtr_Gauss.autotvin_out_V_dest_V.dat"
...
#define AUTOTB_TVOUT_PC_out_V_data_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_data_V.dat"
// tvout file define: "out_V_keep_V"
#define AUTOTB_TVOUT_PC_out_V_keep_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_keep_V.dat"
// tvout file define: "out_V_strb_V"
#define AUTOTB_TVOUT_PC_out_V_strb_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_strb_V.dat"
// tvout file define: "out_V_user_V"
#define AUTOTB_TVOUT_PC_out_V_user_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_user_V.dat"
// tvout file define: "out_V_last_V"
#define AUTOTB_TVOUT_PC_out_V_last_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_last_V.dat"
// tvout file define: "out_V_id_V"
#define AUTOTB_TVOUT_PC_out_V_id_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_id_V.dat"
// tvout file define: "out_V_dest_V"
#define AUTOTB_TVOUT_PC_out_V_dest_V  "../tv/rtldatafile/rtl.filtr_Gauss.autotvout_out_V_dest_V.dat"
...
hls::stream<ap_axiu<8, 1, 1, 1 > > (&out))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<8> > out_V_data_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_data_V
				{
					...
					// {
						...
						// {
							sc_lv<8>* out_V_data_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<8>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out.V.data.V(7, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_V_data_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(7, 0) = sc_bv<8>(out_V_data_V_pc_buffer[hls_map_index].range(7, 0));
										hls_map_index++;
									}
								}
							}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<1> > out_V_keep_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_keep_V
				{
					// bitslice(0, 0)
					// {
						// celement: out.V.keep.V(0, 0)
						// {
							sc_lv<1>* out_V_keep_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<1>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out.V.keep.V(0, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_V_keep_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(0, 0) = sc_bv<1>(out_V_keep_V_pc_buffer[hls_map_index].range(0, 0));
										hls_map_index++;
									}
								}
							}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<1> > out_V_strb_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_strb_V
				{
					// bitslice(0, 0)
					// {
						// celement: out.V.strb.V(0, 0)
						// {
							sc_lv<1>* out_V_strb_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<1>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out.V.strb.V(0, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_V_strb_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(0, 0) = sc_bv<1>(out_V_strb_V_pc_buffer[hls_map_index].range(0, 0));
										hls_map_index++;
									}
								}
							}
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_3.clear();
		...
		sc_bv<8>* in_V_data_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_1 - aesl_tmp_2];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_0[0].data) != NULL) // check the null address if the c port is array or others
							{
								...
								in_V_data_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = in_V_data_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		sc_bv<1>* in_V_keep_V_tvin_wrapc_buffer = new sc_bv<1>[aesl_tmp_1 - aesl_tmp_2];
				...
				// celement: in.V.keep.V(0, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<1> in_V_keep_V_tmp_mem;
								in_V_keep_V_tmp_mem = (aesl_tmp_0[i_0].keep).to_string(2).c_str();
								in_V_keep_V_tvin_wrapc_buffer[hls_map_index].range(0, 0) = in_V_keep_V_tmp_mem.range(0, 0);
                                 		       hls_map_index++;
							}
						}
					}
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		sc_bv<1>* in_V_strb_V_tvin_wrapc_buffer = new sc_bv<1>[aesl_tmp_1 - aesl_tmp_2];
				...
				// celement: in.V.strb.V(0, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<1> in_V_strb_V_tmp_mem;
								in_V_strb_V_tmp_mem = (aesl_tmp_0[i_0].strb).to_string(2).c_str();
								in_V_strb_V_tvin_wrapc_buffer[hls_map_index].range(0, 0) = in_V_strb_V_tmp_mem.range(0, 0);
                                 		       hls_map_index++;
							}
						}
					}
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		sc_bv<8>* out_V_data_V_tvout_wrapc_buffer = new sc_bv<8>[aesl_tmp_4 - aesl_tmp_5];
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].data) != NULL) // check the null address if the c port is array or others
							{
								...
								out_V_data_V_tvout_wrapc_buffer[hls_map_index].range(7, 0) = out_V_data_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<1>* out_V_keep_V_tvout_wrapc_buffer = new sc_bv<1>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out.V.keep.V(0, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].keep) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<1> out_V_keep_V_tmp_mem;
								out_V_keep_V_tmp_mem = (aesl_tmp_3[i_0].keep).to_string(2).c_str();
								out_V_keep_V_tvout_wrapc_buffer[hls_map_index].range(0, 0) = out_V_keep_V_tmp_mem.range(0, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<1>* out_V_strb_V_tvout_wrapc_buffer = new sc_bv<1>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out.V.strb.V(0, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].strb) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<1> out_V_strb_V_tmp_mem;
								out_V_strb_V_tmp_mem = (aesl_tmp_3[i_0].strb).to_string(2).c_str();
								out_V_strb_V_tvout_wrapc_buffer[hls_map_index].range(0, 0) = out_V_strb_V_tmp_mem.range(0, 0);
                                 		       hls_map_index++;
							}
						}
					}
