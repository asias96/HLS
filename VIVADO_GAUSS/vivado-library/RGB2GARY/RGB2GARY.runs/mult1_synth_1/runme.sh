...
HD_PWD='/home/lsriw/HLS/HLS/VIVADO_GAUSS/vivado-library/RGB2GARY/RGB2GARY.runs/mult1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult1.tcl
