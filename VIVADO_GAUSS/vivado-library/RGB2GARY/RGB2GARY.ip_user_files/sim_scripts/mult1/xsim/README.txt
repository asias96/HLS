...
#
# Generated by export_simulation on Wed Jan 15 11:16:44 CET 2020
#
################################################################################
...
'-reset_run' switch to the './mult1.sh' script.
...
./mult1.sh -noclean_files

For more information on the script, please type './mult1.sh -help'.
