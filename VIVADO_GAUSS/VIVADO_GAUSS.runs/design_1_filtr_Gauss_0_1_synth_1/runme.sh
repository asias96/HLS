...
HD_PWD='/home/lsriw/HLS/HLS/VIVADO_GAUSS/VIVADO_GAUSS.runs/design_1_filtr_Gauss_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_filtr_Gauss_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_filtr_Gauss_0_1.tcl
