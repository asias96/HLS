...
architecture behav of fir is 
    ...
    "fir,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.232000,HLS_SYN_LAT=190,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=14,HLS_SYN_FF=2149,HLS_SYN_LUT=2761,HLS_VERSION=2018_3}";
    ...
    signal i_1_fu_199_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_1_reg_322 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal acc_reg_116 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_phi_mux_i_phi_fu_132_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_reg_128 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_phi_mux_data_in_load_phi_phi_fu_142_p18 : STD_LOGIC_VECTOR (63 downto 0);
    signal data_in_load_phi_reg_139 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    acc_reg_116_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    data_in_load_phi_reg_139_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
                if ((ap_const_boolean_1 = ap_condition_457)) then 
                    data_in_load_phi_reg_139 <= data_in_8;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_8)) then 
                    data_in_load_phi_reg_139 <= data_in_7;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_7)) then 
                    data_in_load_phi_reg_139 <= data_in_6;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_6)) then 
                    data_in_load_phi_reg_139 <= data_in_5;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_5)) then 
                    data_in_load_phi_reg_139 <= data_in_4;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_4)) then 
                    data_in_load_phi_reg_139 <= data_in_3;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_3)) then 
                    data_in_load_phi_reg_139 <= data_in_2;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_2)) then 
                    data_in_load_phi_reg_139 <= data_in_1;
                elsif ((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_fu_193_p2 = ap_const_lv1_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_1) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_2) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_3) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_4) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_5) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_6) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_7) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_8) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, probe_in_ap_vld_in_sig, ap_CS_fsm_state2, tmp_fu_193_p2)
    begin
        case ap_CS_fsm is
    ...
    ap_condition_457_assign_proc : process(ap_phi_mux_i_phi_fu_132_p4)
    begin
                ap_condition_457 <= (not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_8)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_7)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_6)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_5)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_4)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_3)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_2)) and not((ap_phi_mux_i_phi_fu_132_p4 = ap_const_lv4_1)));
    end process;
    ...
    ap_phi_mux_data_in_load_phi_phi_fu_142_p18_assign_proc : process(data_in_0, data_in_1, data_in_2, data_in_3, data_in_4, data_in_5, data_in_6, data_in_7, data_in_8, ap_CS_fsm_state2, tmp_fu_193_p2, ap_phi_mux_i_phi_fu_132_p4, ap_condition_457)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_fu_193_p2 = ap_const_lv1_0))) then
            if ((ap_const_boolean_1 = ap_condition_457)) then 
    ...
    ap_phi_mux_i_phi_fu_132_p4 <= i_reg_128;
    ...
    coeff_address0_assign_proc : process(ap_CS_fsm_state2, tmp_fu_193_p2, tmp_3_fu_250_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
            if ((tmp_fu_193_p2 = ap_const_lv1_1)) then 
                coeff_address0 <= ap_const_lv64_0(4 - 1 downto 0);
            elsif ((tmp_fu_193_p2 = ap_const_lv1_0)) then 
                coeff_address0 <= tmp_3_fu_250_p1(4 - 1 downto 0);
            else 
                coeff_address0 <= "XXXX";
            end if;
        else 
    ...
    coeff_ce0_assign_proc : process(ap_CS_fsm_state2, tmp_fu_193_p2)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_fu_193_p2 = ap_const_lv1_1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_fu_193_p2 = ap_const_lv1_0)))) then 
    ...
    grp_fu_169_p0_assign_proc : process(reg_182, data_in_load_phi_reg_139, ap_CS_fsm_state10, ap_CS_fsm_state28)
    begin
    ...
    grp_fu_169_p1_assign_proc : process(probe_in_in_sig, reg_182, ap_CS_fsm_state10, ap_CS_fsm_state28)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state28)) then 
    ...
    i_1_fu_199_p2 <= std_logic_vector(unsigned(i_reg_128) + unsigned(ap_const_lv4_F));
    out_r <= grp_fu_163_p2;
    ...
    tmp_3_fu_250_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_128),64));
    tmp_fu_193_p2 <= "1" when (i_reg_128 = ap_const_lv4_0) else "0";
end behav;
