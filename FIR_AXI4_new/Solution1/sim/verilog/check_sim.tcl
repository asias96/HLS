# ==============================================================
# File generated on Wed Oct 30 11:37:46 CET 2019
...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fir.autotvin_stream_in_V_data_V.dat"
         "c.fir.autotvin_stream_in_V_keep_V.dat"
         "c.fir.autotvin_stream_in_V_strb_V.dat"
         "c.fir.autotvin_stream_in_V_user_V.dat"
         "c.fir.autotvin_stream_in_V_last_V.dat"
         "c.fir.autotvin_stream_in_V_id_V.dat"
         "c.fir.autotvin_stream_in_V_dest_V.dat"
         "c.fir.autotvin_stream_out_V_data_V.dat"
         "c.fir.autotvin_stream_out_V_keep_V.dat"
         "c.fir.autotvin_stream_out_V_strb_V.dat"
         "c.fir.autotvin_stream_out_V_user_V.dat"
         ...
         "c.fir.autotvout_stream_out_V_user_V.dat"
         "c.fir.autotvout_stream_out_V_last_V.dat"
         "c.fir.autotvout_stream_out_V_id_V.dat"
         "c.fir.autotvout_stream_out_V_dest_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fir.autotvout_stream_out_V_data_V.dat"
         "rtl.fir.autotvout_stream_out_V_keep_V.dat"
         "rtl.fir.autotvout_stream_out_V_strb_V.dat"
         "rtl.fir.autotvout_stream_out_V_user_V.dat"
         "rtl.fir.autotvout_stream_out_V_last_V.dat"
         "rtl.fir.autotvout_stream_out_V_id_V.dat"
         "rtl.fir.autotvout_stream_out_V_dest_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
