...
`define TV_OUT_stream_out_TDATA "./impl_rtl.fir.autotvout_stream_out_V_data_V.dat"
`define EGRESS_STATUS_stream_out_TDATA "./stream_egress_status_stream_out_V_data_V.dat"
`define TV_OUT_stream_out_TKEEP "./impl_rtl.fir.autotvout_stream_out_V_keep_V.dat"
`define EGRESS_STATUS_stream_out_TKEEP "./stream_egress_status_stream_out_V_keep_V.dat"
`define TV_OUT_stream_out_TSTRB "./impl_rtl.fir.autotvout_stream_out_V_strb_V.dat"
`define EGRESS_STATUS_stream_out_TSTRB "./stream_egress_status_stream_out_V_strb_V.dat"
`define TV_OUT_stream_out_TUSER "./impl_rtl.fir.autotvout_stream_out_V_user_V.dat"
`define EGRESS_STATUS_stream_out_TUSER "./stream_egress_status_stream_out_V_user_V.dat"
`define TV_OUT_stream_out_TLAST "./impl_rtl.fir.autotvout_stream_out_V_last_V.dat"
`define EGRESS_STATUS_stream_out_TLAST "./stream_egress_status_stream_out_V_last_V.dat"
`define TV_OUT_stream_out_TID "./impl_rtl.fir.autotvout_stream_out_V_id_V.dat"
`define EGRESS_STATUS_stream_out_TID "./stream_egress_status_stream_out_V_id_V.dat"
`define TV_OUT_stream_out_TDEST "./impl_rtl.fir.autotvout_stream_out_V_dest_V.dat"
`define EGRESS_STATUS_stream_out_TDEST "./stream_egress_status_stream_out_V_dest_V.dat"
...
module AESL_axi_s_stream_out (
    ...
    fifo #(600, 32) fifo_stream_out_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 4) fifo_stream_out_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 4) fifo_stream_out_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 2) fifo_stream_out_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 1) fifo_stream_out_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 5) fifo_stream_out_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 6) fifo_stream_out_TDEST (
        .reset(1'b0),
        .write_clock(clk),
