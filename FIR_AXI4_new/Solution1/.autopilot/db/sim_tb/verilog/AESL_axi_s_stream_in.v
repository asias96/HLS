...
`define TV_IN_stream_in_TDATA "./c.fir.autotvin_stream_in_V_data_V.dat"
`define INGRESS_STATUS_stream_in_TDATA "./stream_ingress_status_stream_in_V_data_V.dat"
`define TV_IN_stream_in_TKEEP "./c.fir.autotvin_stream_in_V_keep_V.dat"
`define INGRESS_STATUS_stream_in_TKEEP "./stream_ingress_status_stream_in_V_keep_V.dat"
`define TV_IN_stream_in_TSTRB "./c.fir.autotvin_stream_in_V_strb_V.dat"
`define INGRESS_STATUS_stream_in_TSTRB "./stream_ingress_status_stream_in_V_strb_V.dat"
`define TV_IN_stream_in_TUSER "./c.fir.autotvin_stream_in_V_user_V.dat"
`define INGRESS_STATUS_stream_in_TUSER "./stream_ingress_status_stream_in_V_user_V.dat"
`define TV_IN_stream_in_TLAST "./c.fir.autotvin_stream_in_V_last_V.dat"
`define INGRESS_STATUS_stream_in_TLAST "./stream_ingress_status_stream_in_V_last_V.dat"
`define TV_IN_stream_in_TID "./c.fir.autotvin_stream_in_V_id_V.dat"
`define INGRESS_STATUS_stream_in_TID "./stream_ingress_status_stream_in_V_id_V.dat"
`define TV_IN_stream_in_TDEST "./c.fir.autotvin_stream_in_V_dest_V.dat"
`define INGRESS_STATUS_stream_in_TDEST "./stream_ingress_status_stream_in_V_dest_V.dat"
...
module AESL_axi_s_stream_in (
    ...
    fifo #(600, 32) fifo_stream_in_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 4) fifo_stream_in_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 4) fifo_stream_in_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 2) fifo_stream_in_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 1) fifo_stream_in_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(600, 6) fifo_stream_in_TDEST (
        .reset(1'b0),
        .write_clock(clk),
